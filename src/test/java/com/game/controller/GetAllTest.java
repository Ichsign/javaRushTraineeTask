...
public class GetAllTest extends AbstractTest {
    ...
    public void getAllWithFiltersAfterBeforeMinExperienceMaxExperience() throws Exception {
        ...
        ResultActions resultActions = mockMvc.perform(get("/rest/players?after=1104530400000&before=1230760800000&minExperience=30000&maxExperience=100000&pageNumber=1&pageSize=3"))
                .andExpect(status().isOk());
